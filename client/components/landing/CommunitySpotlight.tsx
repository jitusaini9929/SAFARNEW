            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="text-center lg:text-left">
                    <h2 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 dark:text-white mb-4 md:mb-6 leading-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-purple-500">{t('community.heading_mehfil')}</span>
                    </h2>
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4 px-2 md:px-0">
                    <div className="space-y-3 md:space-y-4">
                        <div className="bg-white dark:bg-[#1E293B] rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-shadow">
                            <h4 className="font-bold text-sm md:text-base text-slate-900 dark:text-white mb-1">{t('community.card1')}</h4>
                        </div>
                        <div className="bg-white dark:bg-[#1E293B] rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-shadow">
                            <h4 className="font-bold text-sm md:text-base text-slate-900 dark:text-white mb-1">{t('community.card2')}</h4>
                        </div>
                    </div>
                    <div className="space-y-3 md:space-y-4 mt-6 md:mt-8">
                        <div className="bg-white dark:bg-[#1E293B] rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-shadow">
                            <h4 className="font-bold text-sm md:text-base text-slate-900 dark:text-white mb-1">{t('community.card3')}</h4>
                        </div>
                        <div className="bg-white dark:bg-[#1E293B] rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-shadow">
                            <h4 className="font-bold text-sm md:text-base text-slate-900 dark:text-white mb-1">{t('community.card4')}</h4>
                        </div>
                    </div>
                </div>
            </div>
