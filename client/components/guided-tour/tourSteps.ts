...
export const studyPlannerTour: TourConfig = {
    ...
    steps: [
        ...
        },
        {
            ...
            title: "Views",
            content: "Use these tabs to move between Today, Plan, Syllabus, and Calendar. We will switch views as we go.",
            placement: "bottom",
        },
        {
        ...
        },
        {
            ...
            title: "Pace Metrics",
            content: "Track days left, completed topics, today's workload, overall status, and next off day.",
            placement: "bottom",
            spotlightPadding: 14,
        },
        {
            target: "[data-tour='planner-today-tasks']",
            title: "Today's Tasks",
            content: "Start work, mark done, or open More to revise, move dates, and edit notes.",
            placement: "right",
            spotlightPadding: 12,
        },
        {
            target: "[data-tour='planner-upcoming']",
            title: "Coming Up",
            content: "Upcoming tasks stay visible so you can mark done early or move dates.",
            placement: "right",
            spotlightPadding: 12,
        },
        {
            target: "[data-tour='planner-overdue']",
            title: "Overdue Queue",
            content: "Late tasks surface here. Reschedule them or skip to keep the plan realistic.",
            placement: "right",
            spotlightPadding: 12,
        },
        {
            ...
            content: "Click the Plan tab now. The next steps cover plan settings and scheduling logic.",
            placement: "bottom",
        },
        {
            target: "[data-tour='planner-plan-basics']",
            title: "Plan Settings",
            content: "Set the plan title, exam type/date, daily goal, and off days. These drive scheduling.",
            placement: "right",
            spotlightPadding: 14,
        },
        {
            ...
            content: "Auto Schedule builds the calendar. Advanced actions clear future dates or reset the plan. Progress Snapshot shows status totals.",
            placement: "left",
            spotlightPadding: 14,
        },
        {
