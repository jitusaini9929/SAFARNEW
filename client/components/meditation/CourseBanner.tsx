    ...
    <section className="rounded-2xl border border-slate-200/80 dark:border-white/10 bg-white/80 dark:bg-[#11131C]/80 backdrop-blur-md p-4 shadow-xl shadow-cyan-500/5">
      ...
      <div className="mt-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="w-full rounded-xl safar-btn-primary font-semibold text-sm px-4 py-2.5 hover:scale-[1.01] transition-all inline-flex items-center justify-center gap-2"
        >
