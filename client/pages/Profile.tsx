        ...
        <main className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
            ...
            <button
              ...
              aria-label="Logout"
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm action-btn-nowrap"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
              </svg>
              <span className="action-label-mobile-hidden">{t('profile.logout')}</span>
            </button>
          </div>
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bento-card bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-100 dark:border-slate-700 flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-lg">{t('profile.personal_info')}</h3>
                </div>
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                      <label className="text-[11px] uppercase tracking-widest font-bold text-slate-400 dark:text-slate-500">{t('profile.gender')}</label>
                      <div className="relative">
                        ...
                        >
                          <option value="Male" className="bg-white dark:bg-slate-800">{t('auth.male')}</option>
                          <option value="Female" className="bg-white dark:bg-slate-800">{t('auth.female')}</option>
                          <option value="Other" className="bg-white dark:bg-slate-800">{t('auth.other')}</option>
                        </select>
              ...
              <div className="bento-card bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-100 dark:border-slate-700 flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-lg">{t('profile.exam_focus')}</h3>
                </div>
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-[11px] uppercase tracking-widest font-bold text-slate-400 dark:text-slate-500">{t('profile.target_exam')}</label>
                      <div className="relative">
                        <select
                          className="w-full bg-transparent border-0 border-b border-slate-200 dark:border-slate-600 px-0 pb-2 focus:ring-0 focus:border-emerald-500 transition-colors font-medium appearance-none text-slate-900 dark:text-white"
                    ...
                    <div className="space-y-2">
                      <label className="text-[11px] uppercase tracking-widest font-bold text-slate-400 dark:text-slate-500">{t('profile.prep_stage')}</label>
                      <div className="relative">
                        <select
                          className="w-full bg-transparent border-0 border-b border-slate-200 dark:border-slate-600 px-0 pb-2 focus:ring-0 focus:border-emerald-500 transition-colors font-medium appearance-none text-slate-900 dark:text-white"
                        ...
                        >
                          <option value="Beginner" className="bg-white dark:bg-slate-800">{t('auth.beginner')}</option>
                          <option value="Intermediate" className="bg-white dark:bg-slate-800">{t('auth.intermediate')}</option>
                          <option value="Advanced" className="bg-white dark:bg-slate-800">{t('auth.advanced')}</option>
                        </select>
                        <svg className="absolute right-0 bottom-2 w-4 h-4 text-slate-400 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
              ...
              <div className="bento-card bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">{t('profile.account_status')}</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">{t('profile.account_verified')}</p>
                  </div>
                </div>
